import {generateAllSubArrays} from "../../../main/subarray/dfs/AllSubArrays.js";
import {stringToArray} from "../../../../utils/Converters.js";
import {generateAllSubSequences} from "../../combination-subsequence/dfs/AllSubSequences.js";
...
console.log(generateAllSubArrays( []));
console.log(generateAllSubArrays([1,2,3,4]));


// Subarray = Substring != Subsequence
console.log('Subarray = Substring')
console.log(generateAllSubArrays([1,2,3]));
console.log(generateAllSubArrays(stringToArray('abc')));
// Subsequence = Subset != Subarray
console.log('Subsequence = Subset')
console.log(generateAllSubSequences([1,2,3]));
console.log(generateAllSubSequences(stringToArray('abc')));
