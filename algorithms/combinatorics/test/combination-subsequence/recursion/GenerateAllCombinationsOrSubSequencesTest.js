...
console.log(generateAllCombinationsOrSubSequences(0, [1,2,3], [], []));
console.log(generateAllCombinationsOrSubSequences(0, [], [], []));
console.log(generateAllCombinationsOrSubSequences(0, [1,2,3,4], [], []));
